                ...
                switch($key) { 
                    case 'location':
                        ...
                        <div class="<?php echo esc_attr($location_classes).' '.esc_attr($radius_class); ?>">
                            ...
                            <div id="remove_me_on_ready" data-id="ok"  class="btn-group bootstrap-select">
                                <button type="button" class="btn dropdown-toggle bs-placeholder btn-default" data-toggle="dropdown" role="button" title="Where to go?">
                                    <span class="filter-option pull-left">Where to go?</span>&nbsp;<span class="bs-caret"><span class="caret"></span></span>
                                </button>
                                    ...
                                    <ul class="dropdown-menu inner" role="listbox" aria-expanded="false">
                                        <li data-original-index="0" class="selected">
                                            <a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="true">
                                                <span class="text">Where to go?</span><span class="glyphicon glyphicon-ok check-mark"></span></a>
                                        </li>
                                    </ul>
                                </div>
                        </div>
